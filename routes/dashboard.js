...
router.get("/customers", wrapAsync(async (req, res) => {
...
router.get("/employee", wrapAsync(async (req, res) => {
...
router.get("/employee/new", wrapAsync(async (req, res) => {
  res.render("newEmp.ejs");
}));


// New Employee Adding in Database
router.post("/employee", wrapAsync(async (req, res) => {
...
router.get("/employee/:id/edit", wrapAsync(async (req, res) => {
  let { id } = req.params;
...
router.put("/employee/:id", wrapAsync(async (req, res) => {
  let { id } = req.params;
  let newData = {
    name: req.body.name,
    age: req.body.age,
...
router.get("/menu", wrapAsync(async (req, res) => {
...
router.get("/menu/new", wrapAsync((req, res) => {
  res.render("newItem.ejs");
}));


// Rendering Editing item details page
router.get("/menu/:id/edit", wrapAsync(async (req, res) => {
  let { id } = req.params;
...
router.put("/menu/:id", wrapAsync(async (req, res) => {
  let { id } = req.params;
...
router.post("/menu", wrapAsync(async (req, res) => {
...
router.get("/table", wrapAsync(async (req, res) => {
...
router.get("/table/view/:id", wrapAsync(async (req, res) => {
  let { id } = req.params;
